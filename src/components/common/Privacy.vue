  ...
  <div class="terms_container">
    ...
    <section id="page">
      <div class="content">
        ...
        5) 표시/광고에 관한 기록 : 6개월<br /><br /><br />
        <h class="title-3">제3조 (처리하는 개인정보의 항목)</h><br />
        ① "우리 모두 철학자"은(는) 다음의 개인정보 항목을 처리하고 있습니다.<br />
        <b>가. 홈페이지 회원가입 및 관리</b><br />
        필수항목 : 이메일, 비밀번호, 로그인ID, 성별, 생년월일, 서비스 이용 기록,
        접속 로그, 쿠키<br /><br /><br />
        <h class="title-4">제4조 (개인정보의 파기절차 및 파기방법)</h><br />
        ① "우리 모두 철학자" 은(는) 개인정보 보유기간의 경과, 처리목적 달성 등
        ...
        <b>가. 파기절차</b><br />
        "우리 모두 철학자" 은(는) 파기 사유가 발생한 개인정보를 선정하고, "우리
        모두 철학자" 의 개인정보 보호책임자의 승인을 받아 개인정보를
        파기합니다.<br />
        <b>나. 파기방법</b><br />
        ...
        <h class="title-5"
          ...
          사항)</h
        ><br />
        ① 정보주체는 우리 모두 철학자에 대해 언제든지 개인정보
        열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다.<br />
        ② 제1항에 따른 권리 행사는우리 모두 철학자에 대해 「개인정보 보호법」
        시행령 제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실
        수 있으며 우리 모두 철학자은(는) 이에 대해 지체 없이 조치하겠습니다.<br />
        ...
        제37조 제2항에 의하여 정보주체의 권리가 제한될 수 있습니다.<br />
        ⑤ 개인정보의 정정 및 삭제 요구는 다른 법령에서 그 개인정보가 수집
        대상으로 명시되어 있는 경우에는 그 삭제를 요구할 수 없습니다.<br />
        ⑥ 우리 모두 철학자은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의
        요구, 처리정지의 요구 시 열람 등 요구를 한 자가 본인이거나 정당한
        대리인인지를 확인합니다.<br /><br /><br />
        <h class="title-6">제6조 (개인정보의 안전성 확보조치에 관한 사항)</h
        ><br />
        "우리 모두 철학자"은(는) 개인정보의 안전성 확보를 위해 다음과 같은
        조치를 취하고 있습니다.<br />
        <b>가. 내부관리계획의 수립 및 시행</b><br />
        ...
        <h class="title-7"
          ...
          관한 사항)</h
        ><br />
        ① 우리 모두 철학자 은(는) 이용자에게 개별적인 맞춤서비스를 제공하기 위해
        ...
        있습니다.<br /><br /><br />
        <h class="title-8">제8조 (개인정보 보호책임자에 관한 사항)</h><br />
        ① 우리 모두 철학자 은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고,
        ...
        직책 :우리 모두 철학자/관리자<br />
        직급 :우리 모두 철학자/관리자<br />
        ② 정보주체께서는 우리 모두 철학자 의 서비스(또는 사업)을 이용하시면서
        발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을
        개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. 우리 모두 철학자
        은(는) 정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴 것입니다.<br /><br /><br />
        <h class="title-9">제9조 (개인정보의 열람청구를 접수·처리하는 부서)</h
        ><br />
        정보주체는 ｢개인정보 보호법｣ 제35조에 따른 개인정보의 열람 청구를 아래의
        부서에 할 수 있습니다.<br />
        "우리 모두 철학자"은(는) 정보주체의 개인정보 열람청구가 신속하게
        처리되도록 노력하겠습니다.<br />
        ▶ 개인정보 열람청구 접수·처리 부서<br />
        부서명 : 우리 모두 철학자<br />
        담당자 : 우리 모두 철학자/관리자<br /><br /><br />
        <h class="title-10">제10조 (정보주체의 권익침해에 대한 구제방법)</h
        ><br />
        ...
        홈페이지를 참고하시기 바랍니다.<br /><br /><br />
        <h class="title-11">제11조 (개인정보 처리방침 변경)</h><br />
        ① 이 개인정보처리방침은 2023년 3월 4일부터 적용됩니다.<br /><br /><br />
      </div>
    </section>
  </div>
